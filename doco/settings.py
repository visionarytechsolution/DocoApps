...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['https://admin.mydoco.in', 'http://127.0.0.1', 'http://0.0.0.0:8000', 'http://localhost:8080/']
...
MIDDLEWARE = [
    ...
    # for cors related issue in frontend
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        'doco.middleware.doco_response.DocoJsonResponse',
    ),
